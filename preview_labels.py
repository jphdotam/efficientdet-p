...
annotation_file = r'E:\Dropbox\Work\Papers\ALGE\data\data_processed\annotations\train.json'
image_root = r"E:\Dropbox\Work\Papers\ALGE\data\data_processed\train"
coco = COCO(annotation_file)

# Select one image to display
image_ids = coco.getImgIds()
image_data = coco.loadImgs(image_ids[100])[0]  # Load the first image info
